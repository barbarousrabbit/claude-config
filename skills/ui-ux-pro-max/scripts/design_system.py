...
def format_master_md(design_system: dict) -> str:
    ...
    lines.append(f"  background: {colors.get('cta', DEFAULT_CTA_COLOR)};")
    ...
    lines.append(f"  color: {colors.get('primary', DEFAULT_PRIMARY_COLOR)};")
    lines.append(f"  border: 2px solid {colors.get('primary', DEFAULT_PRIMARY_COLOR)};")
    lines.append("  padding: 12px 24px;")
    lines.append("  border-radius: 8px;")
    lines.append("  font-weight: 600;")
    lines.append("  transition: all 200ms ease;")
