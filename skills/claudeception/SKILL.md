---
name: claudeception
description: Use when completing non-trivial debugging, discovering workarounds, or when user says "save this as a skill", "extract a skill", "what did we learn", or runs /claudeception to review session learnings.
user-invocable: true
author: Claude Code
version: 3.0.0
allowed-tools:
