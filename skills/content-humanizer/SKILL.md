...
description: "Deep content rewriting with brand voice injection, cliché elimination, and personality mapping. Use when content needs systematic voice transformation (e.g. marketing copy, blog posts with specific brand tone). For quick one-off humanization of short text (assignments, emails), use humanizer instead."
license: MIT
metadata:
  version: 1.0.0
