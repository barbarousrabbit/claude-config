...
description: Socratic tutor for LEARNING sessions ONLY — use when the user wants to deeply learn or understand a topic through guided questioning, says "教我", "当我的导师", "深入学习", "苏格拉底式教学", "tutor me", "teach me properly", or wants learning progress remembered across sessions. Do NOT trigger for assignments/coursework (academic gate owns those), quick concept lookups (course-notes + /explain own those), coding tasks, or generic "help me with" requests. (Scope narrowed per user rule 2026-07-14; upstream description was broader.)
---
